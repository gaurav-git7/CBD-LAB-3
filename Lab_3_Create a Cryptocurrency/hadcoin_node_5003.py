...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Abcde', amount = 1) # Hadcoins to mine the block (A Reward). So the node gives 1 hadcoin to Abcde for mining the block
